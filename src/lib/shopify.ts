...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'lovable-project-79ft9.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '0dcc7f2a3dd9dcd27cec610fcfb5265a';
...
export async function fetchProducts(searchQuery?: string): Promise<ShopifyProduct[]> {
